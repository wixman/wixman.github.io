...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    // ray origin
    vec3 ro = vec3(0.0, -0.3, iGlobalTime- 5.0);
    ...
    float dist  = distance(center, uvn) * 1.414213; // Distance  between center and the current Uv. Multiplyed by 1.414213 to fit in the range of 0.0 to 1.0 
